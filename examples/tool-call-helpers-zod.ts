...
import { RunnableToolFunctionWithParse } from 'startgpt/lib/RunnableFunction';
import { JSONSchema } from 'startgpt/lib/jsonschema';
...
async function main() {
  const runner = await startgpt.beta.chat.completions
    .runTools({
