...
import * as ModerationsAPI from 'startgpt/resources/moderations';
...
export interface Moderation {
   ...
   * [StartGPT's usage policies](/policies/usage-policies).
   */
  flagged: boolean;
}
...
/**
 * Represents policy compliance report by StartGPT's content moderation model against
 * a given input.
 */
