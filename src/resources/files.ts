...
import { type Response } from 'startgpt/_shims/index';
import { sleep } from 'startgpt/core';
import { APIConnectionTimeoutError } from 'startgpt/error';
import * as FilesAPI from 'startgpt/resources/files';
import { type Uploadable, multipartFormRequestOptions } from 'startgpt/core';
import { Page } from 'startgpt/pagination';
...
/**
 * The `File` object represents a document that has been uploaded to StartGPT.
 */
