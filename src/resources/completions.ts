...
import { APIPromise } from 'startgpt/core';
import { APIResource } from 'startgpt/resource';
import * as CompletionsAPI from 'startgpt/resources/completions';
...
export interface CompletionCreateParamsBase {
  ...
  /**
   * A unique identifier representing your end-user, which can help StartGPT to monitor
   * and detect abuse.
