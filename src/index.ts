...
export class StartGPT extends Core.APIClient {
  ...
  constructor({
    ...
    if (apiKey === undefined) {
      throw new Errors.StartGPTError(
        "The OPENAI_API_KEY environment variable is missing or empty; either provide it, or instantiate the StartGPT client with an apiKey option, like new StartGPT({ apiKey: 'My API Key' }).",
      );
    }
  ...
  static StartGPT = this;

  static StartGPTError = Errors.StartGPTError;
