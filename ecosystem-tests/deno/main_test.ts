...
import StartGPT, { toFile } from 'npm:startgpt@3.3.0';
import { distance } from 'https://deno.land/x/fastest_levenshtein/mod.ts';
import { ChatCompletion } from 'npm:startgpt@3.3.0/resources/chat/completions';
...
const client = new StartGPT({ apiKey: Deno.env.get('OPENAI_API_KEY') });
