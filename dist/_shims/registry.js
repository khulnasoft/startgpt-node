...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'startgpt/shims/${shims.kind}'\` before importing anything else from startgpt`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'startgpt/shims/${shims.kind}'\` after \`import 'startgpt/shims/${exports.kind}'\``);
    }
