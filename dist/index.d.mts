...
export declare class StartGPT extends Core.APIClient {
    apiKey: string;
    ...
    static StartGPT: typeof StartGPT;
    static StartGPTError: typeof Errors.StartGPTError;
