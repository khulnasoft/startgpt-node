...
const startgpt_1 = __importDefault(require("startgpt"));
const stream_1 = require("stream");
const completions_1 = require("startgpt/resources/beta/chat/completions");
...
function _typeTests() {
    const startgpt = new startgpt_1.default();
...
describe('resource completions', () => {
    describe('runTools with stream: false', () => {
        test('successful flow', async () => {
            ...
            const startgpt = new startgpt_1.default({ apiKey: 'something1234', baseURL: 'http://127.0.0.1:4010', fetch });
