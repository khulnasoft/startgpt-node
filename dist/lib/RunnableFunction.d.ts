...
export type RunnableFunctionWithoutParse = {
    /**
     * @param args the raw args from the StartGPT function call.
     * @returns a string to send back to StartGPT
     */
